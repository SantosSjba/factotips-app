...
export function UitLanding() {
  const { t } = useI18n();
  const appHref = TOOL_ROUTES.uit.appPath;
  const p = t.uitLanding;
  ...
  const steps = [
    { icon: "mdi:swap-vertical", title: p.step1Title, text: p.step1Text },
    { icon: "mdi:numeric", title: p.step2Title, text: p.step2Text },
    { icon: "mdi:lightning-bolt", title: p.step3Title, text: p.step3Text },
  ] as const;
    ...
    <div>
      <section className="relative isolate overflow-hidden">
        <div
          ...
          aria-hidden
        />
        <HeroParticles variant="hub" id="uit-hero-particles" />
        <div
