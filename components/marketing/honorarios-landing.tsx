...
export function HonorariosLanding() {
  const { t } = useI18n();
  const appHref = TOOL_ROUTES.honorarios.appPath;
  const p = t.honorariosLanding;
  ...
  const steps = [
    ...
    { icon: "mdi:toggle-switch", title: p.step2Title, text: p.step2Text },
    { icon: "mdi:calculator", title: p.step3Title, text: p.step3Text },
  ] as const;
    ...
    <div>
      <section className="relative isolate overflow-hidden">
        <div
          ...
          aria-hidden
        />
        <HeroParticles variant="hub" id="honorarios-hero-particles" />
        <div
      ...
      <RelatedTools toolId="honorarios" />
    </div>
  );
}
