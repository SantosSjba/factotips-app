...
export function IgvLanding() {
  const { t } = useI18n();
  const appHref = TOOL_ROUTES.igv.appPath;
  const p = t.igvLanding;
  ...
  const steps = [
    { icon: "mdi:calculator-variant", title: p.step1Title, text: p.step1Text },
    { icon: "mdi:percent-outline", title: p.step2Title, text: p.step2Text },
    { icon: "mdi:content-copy", title: p.step3Title, text: p.step3Text },
  ] as const;
    ...
    <div>
      <section className="relative isolate overflow-hidden">
        <div
          ...
          aria-hidden
        />
        <HeroParticles variant="hub" id="igv-hero-particles" />
        <div
