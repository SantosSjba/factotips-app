...
export function PdfUnirLanding() {
  const { t } = useI18n();
  const p = t.pdfUnirLanding;
  const appHref = pdfToolAppPath("unir");

  const benefits = [
    { icon: "mdi:call-merge", title: p.benefit1Title, text: p.benefit1Text },
    { icon: "mdi:sort", title: p.benefit2Title, text: p.benefit2Text },
    {
      icon: "mdi:timer-sand",
  ...
  const steps = [
    ...
    { icon: "mdi:reorder-horizontal", title: p.step2Title, text: p.step2Text },
    ...
    <div>
      <section className="relative isolate overflow-hidden">
        <div
          ...
          aria-hidden
        />
        <HeroParticles variant="hub" id="pdf-unir-hero-particles" />
        <div
