...
export function PreciosLanding() {
  const { t } = useI18n();
  const appHref = TOOL_ROUTES.precios.appPath;
  const p = t.preciosLanding;
  ...
  const steps = [
    { icon: "mdi:magnify", title: p.step1Title, text: p.step1Text },
    { icon: "mdi:map-marker-radius", title: p.step2Title, text: p.step2Text },
    { icon: "mdi:scale-balance", title: p.step3Title, text: p.step3Text },
  ] as const;
