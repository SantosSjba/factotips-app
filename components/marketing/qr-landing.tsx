...
export function QrLanding() {
  const { t } = useI18n();
  const appHref = TOOL_ROUTES.qr.appPath;
  const p = t.qrLanding;

  const benefits = [
    { icon: "mdi:palette", title: p.benefit1Title, text: p.benefit1Text },
    { icon: "mdi:image", title: p.benefit2Title, text: p.benefit2Text },
    { icon: "mdi:shield-lock", title: p.benefit3Title, text: p.benefit3Text },
  ] as const;

  const steps = [
    { icon: "mdi:link-variant", title: p.step1Title, text: p.step1Text },
    { icon: "mdi:brush", title: p.step2Title, text: p.step2Text },
    ...
    <div>
      <section className="relative isolate overflow-hidden">
        <div
          ...
          aria-hidden
        />
        <HeroParticles variant="hub" id="qr-hero-particles" />
        <div
