...
export function CtsLanding() {
  const { t } = useI18n();
  const appHref = TOOL_ROUTES.cts.appPath;
  const p = t.ctsLanding;
  ...
  const steps = [
    ...
    { icon: "mdi:calendar-clock", title: p.step2Title, text: p.step2Text },
    { icon: "mdi:piggy-bank", title: p.step3Title, text: p.step3Text },
  ] as const;
    ...
    <div>
      <section className="relative isolate overflow-hidden">
        <div
          ...
          aria-hidden
        />
        <HeroParticles variant="hub" id="cts-hero-particles" />
        <div
