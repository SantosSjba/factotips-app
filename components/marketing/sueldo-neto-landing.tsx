...
export function SueldoNetoLanding() {
  const { t } = useI18n();
  const appHref = TOOL_ROUTES["sueldo-neto"].appPath;
  const p = t.sueldoNetoLanding;
  ...
  const steps = [
    { icon: "mdi:currency-usd", title: p.step1Title, text: p.step1Text },
    { icon: "mdi:account-cash", title: p.step2Title, text: p.step2Text },
    { icon: "mdi:file-chart", title: p.step3Title, text: p.step3Text },
  ] as const;
    ...
    <div>
      <section className="relative isolate overflow-hidden">
        <div
          ...
          aria-hidden
        />
        <HeroParticles variant="hub" id="sueldo-neto-hero-particles" />
        <div
