...
export function GratificacionLanding() {
  const { t } = useI18n();
  const appHref = TOOL_ROUTES.gratificacion.appPath;
  const p = t.gratificacionLanding;
  ...
  const steps = [
    { icon: "mdi:cash", title: p.step1Title, text: p.step1Text },
    { icon: "mdi:hospital-box", title: p.step2Title, text: p.step2Text },
    { icon: "mdi:gift", title: p.step3Title, text: p.step3Text },
  ] as const;
    ...
    <div>
      <section className="relative isolate overflow-hidden">
        <div
          ...
          aria-hidden
        />
        <HeroParticles variant="hub" id="gratificacion-hero-particles" />
        <div
      ...
      <section
        id="como-funciona"
        className="scroll-mt-24 border-t border-border/80"
      >
        <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 sm:py-16">
      ...
      <RelatedTools toolId="gratificacion" />
    </div>
  );
}
