export const es = {
  ...
  pdfLanding: {
    ...
    faq1A:
      "Unir PDF se procesa de forma temporal en nuestro servicio (factotips-py) a través de FactoTips: no se guardan en base de datos. Otras herramientas pueden ser 100% en tu navegador; si usan API o IA, lo avisamos.",
  ...
  pdfUnirLanding: {
    eyebrow: "FactoTips · Kit PDF",
    headline: "Unir PDF online, en el orden que elijas",
    subtitle:
      "Junta 2 o más archivos en un solo PDF. Los procesamos de forma temporal y no los guardamos.",
    ctaPrimary: "Empezar a unir",
    ctaSecondary: "Ver cómo funciona",
    whyTitle: "Varios PDF, un solo archivo",
    whyText:
      "Ideal para contratos, boletas o carpetas escaneadas que necesitas enviar juntas.",
    benefit1Title: "Uno tras otro",
    benefit1Text: "El PDF final respeta el orden de la lista que armas.",
    benefit2Title: "Reordenas antes de unir",
    benefit2Text: "Arrastra o usa las flechas para dejar la secuencia correcta.",
    benefit3Title: "Sin archivo permanente",
    benefit3Text:
      "El proceso es temporal: no guardamos tus documentos en FactoTips.",
    howTitle: "Cómo funciona",
    howSubtitle: "Tres pasos hasta descargar el PDF unido.",
    step1Title: "Sube tus PDF",
    step1Text: "Mínimo 2, máximo 20. Hasta 25 MB por archivo.",
    step2Title: "Ordena la lista",
    step2Text: "El primero de la lista será la primera parte del resultado.",
    step3Title: "Descarga",
    step3Text: "Obtienes un solo PDF listo para compartir.",
    faqTitle: "Preguntas frecuentes",
    ...
    faq3A:
      "Sí. Arrastra cada archivo o usa las flechas arriba/abajo antes de unir.",
    faq4Q: "¿Es gratis y sin registro?",
    faq4A: "Sí. Unir PDF en FactoTips es gratuito y no requiere cuenta.",
    finalTitle: "Listo para juntar tus PDF",
    finalText: "Abre la herramienta, sube los archivos y descarga el resultado.",
    finalCta: "Unir PDF ahora",
    backHub: "Volver al kit PDF",
  },
  pdfUnir: {
    back: "Volver a Unir PDF",
    eyebrow: "Kit PDF · Unir",
    title: "Unir PDF",
    subtitle:
    ...
    listTitle: "{n} archivo(s)",
    clearAll: "Vaciar lista",
    reorderHint: "Arrastra para cambiar el orden.",
    moveUp: "Subir",
    moveDown: "Bajar",
    remove: "Eliminar",
    mergeCta: "Unir y descargar",
    finishCta: "Terminar",
    merging: "Generando…",
    moreTools: "Ver más herramientas PDF",
    disclaimer:
      "Herramienta de FactoTips. Verifica el PDF resultante antes de usarlo en trámites oficiales.",
    tabFiles: "Archivos",
    tabPages: "Páginas",
    ...
    fileNamePlaceholder: "documento-unido",
    fileNamePreview: "Se descargará como {name}",
    statsBar: "{files} archivo(s) · {pages} página(s)",
    filesHint:
      "Arrastra para reordenar. Pasa el mouse entre tarjetas y usa + para insertar.",
    enlarge: "Ver en grande",
    lightboxPrev: "Página anterior",
    lightboxNext: "Página siguiente",
    lightboxPageOf: "Página {n} de {total}",
    pagesHint:
      "Toca una hoja para verla en grande. Arrastra, rota, duplica o elimina. El número es el orden final.",
    workspaceHint:
      "Luego podrás organizar por archivos o página a página, elegir el nombre y descargar.",
    previewTitle: "Vista previa",
    previewOrder: "Así quedará el PDF unido",
    previewEmpty: "Sin archivos aún",
    previewEmptyHint:
      "Cuando subas PDF, aquí verás miniaturas y el orden final.",
    previewResult: "Archivo resultante",
    previewPages: "{n} páginas",
    previewTotalSize: "Tamaño aprox. {size}",
    previewNeedMore: "Falta {n} PDF más para poder unir.",
    errorNotPdf: "“{name}” no es un PDF válido.",
    errorTooLarge: "“{name}” supera {mb} MB.",
    errorMaxFiles: "Máximo {n} archivos por unión.",
    errorMinFiles: "Necesitas al menos {n} PDF para unir.",
    errorMinPages: "Agrega al menos una página para generar el PDF.",
